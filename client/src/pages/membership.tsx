            ...
            <div className="space-y-6">
              ...
              <Card className="shadow-lg border-0 bg-gradient-to-br from-white to-blue-50 dark:from-gray-800 dark:to-gray-900">
                ...
                <CardContent className="space-y-3">
                  {[
                    { icon: <BookOpen className="h-4 w-4 text-blue-500" />, text: t("Extensive book collection") },
                    { icon: <Clock className="h-4 w-4 text-green-500" />, text: t("Extended borrowing time") },
                    { icon: <Users className="h-4 w-4 text-purple-500" />, text: t("Reading recommendations") },
                    { icon: <Shield className="h-4 w-4 text-orange-500" />, text: t("Priority book reservations") },
                    { icon: <Star className="h-4 w-4 text-yellow-500" />, text: t("Digital resources") }
                  ].map((benefit, index) => (
              ...
              <Card className="shadow-lg border-0 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-gray-800 dark:to-emerald-900">
                <CardContent className="p-4">
                  <h3 className="text-lg font-semibold mb-3 text-center text-emerald-700 dark:text-emerald-400">{t('Library at a Glance')}</h3>
                  <div className="grid grid-cols-2 gap-3 text-center">
                    <div className="bg-white dark:bg-gray-700 rounded-lg p-3 shadow-sm">
                      <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">500+</div>
                      <div className="text-xs text-gray-600 dark:text-gray-400">{t('Books')}</div>
                    </div>
                    <div className="bg-white dark:bg-gray-700 rounded-lg p-3 shadow-sm">
                      <div className="text-2xl font-bold text-green-600 dark:text-green-400">100+</div>
                      <div className="text-xs text-gray-600 dark:text-gray-400">{t('Members')}</div>
                    </div>
                    <div className="bg-white dark:bg-gray-700 rounded-lg p-3 shadow-sm">
                      <div className="text-2xl font-bold text-purple-600 dark:text-purple-400">24/7</div>
                      <div className="text-xs text-gray-600 dark:text-gray-400">{t('Access')}</div>
                    </div>
                    <div className="bg-white dark:bg-gray-700 rounded-lg p-3 shadow-sm">
                      <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">FREE</div>
                      <div className="text-xs text-gray-600 dark:text-gray-400">{t('Membership')}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="shadow-lg border-0 bg-gradient-to-r from-blue-500 to-purple-600 text-white">
                <CardContent className="p-4 text-center">
                  <h3 className="text-lg font-bold mb-2">{t('Ready to Join?')}</h3>
                  <p className="text-blue-100 text-sm mb-3">
                   {t('Fill out the form and become part of our learning community today!')}
                  </p>
                  <div className="flex items-center justify-center gap-2 text-sm">
                    <Star className="h-4 w-4 text-yellow-300" />
                    <span>{t('100% Free Registration')}</span>
                    <Star className="h-4 w-4 text-yellow-300" />
                  </div>
                </CardContent>
              </Card>
